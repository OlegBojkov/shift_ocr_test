...
from shift_ocr_test.doc2text.crop import Crop
from shift_ocr_test.doc2text.recognition import Recognizer
from shift_ocr_test.doc2text.segmentation import Detector
